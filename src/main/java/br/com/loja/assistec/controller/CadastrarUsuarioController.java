...
public class CadastrarUsuarioController {
	...
	private void NovoOuAlterar() throws SQLException {
		...
		if (usuarioSelecionado == null) {
			incluir(cadastrarView.getNome(), cadastrarView.getFone(), cadastrarView.getLogin(),
					cadastrarView.getSenha(), perfil);
			new MensagemView("Registro inserido com sucesso!");
		} else {
			...
			new MensagemView("Registro alterado com sucesso!");
		}
		cadastrarView.dispose();
		atualizarListaUsuarios();
	}

	private void alterar(long iduser, String nome, String fone, String login, String senha, String perfil)
			throws SQLException {
	...
	private void Excluir() {
		MensagemView mv = new MensagemView("Tem certez que quer excluir?");
